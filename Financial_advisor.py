...
def get_response(history,user_message,temperature=0):
    print('called')
    DEFAULT_TEMPLATE = """The following is a friendly conversation between a human and an Financial Advisor. The Advisor guides the user regaring savings,investments and other financial decsions.
    It follows the previous conversation to do so

    Relevant pieces of previous conversation:
    {context},

    Useful information from financial literacy books:
    {text}, 

    Useful information from financial literacy from Web:
    {web_knowledge},
